...
这个手机网页端有限制,手机客户端跟电脑端不是很清除,电脑端暂时没有遇到.


然后是博客跟电子书,这里始我找到的几个感觉还不错的.

如果你会其他语言,可以参照
[Y分钟学会IOS分钟](https://learnxinyminutes.com/docs/es-es/objective-c-es/)
快速浏览一下OC的语法.
...
随着年龄的增长,记忆力下降的挺厉害的,真搞不懂究竟是什么原因,所有我都是采取个人整理一次来加强记忆,
毕竟自己写的,每个细节都需要注意的.
